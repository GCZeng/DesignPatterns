...
public class SingletonStaticState {
    private static class SingletonHolder {
        private static final SingletonStaticState INSTANCE = new SingletonStaticState();
    }
    private SingletonStaticState (){}
    public static final SingletonStaticState getInstance() {
